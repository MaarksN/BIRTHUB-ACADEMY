...
export class ExcellenceController {
  ...
  listTutorHistory(@CurrentAuth() auth: AuthContext) {
    return this.excellenceService.listTutorHistory(auth);
  }
  ...
  listQualityScores(@CurrentAuth() auth: AuthContext) {
    return this.excellenceService.listQualityScores(auth);
  }
